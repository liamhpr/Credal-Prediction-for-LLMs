...
if __name__ == "__main__":
    ...
    data = np.array([
        [0.9,  0.1,  0.0,  0.0],   # Sample 1
        [0.8,  0.15, 0.05, 0.0],   # Sample 2 
        [0.75, 0.15, 0.08, 0.02]   # Sample 3
    ])
    ...
    ax = viz.spider_plot(
        probs=data, 
        labels=classes, 
        title="Visualization of City-Classification-Simplex", 
        mle_flag=False, 
        credal_flag=True
    )

    filename = "city_classification_radar.pdf"
