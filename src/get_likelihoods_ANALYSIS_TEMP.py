...
with open(f'{path_prefix}{args.generation_model}_ANALYSIS_TEMP_generations_similarities.pkl', 'rb') as infile:
...
print(f'storing likelihoods in {path_prefix}{args.generation_model}_ANALYSIS_TEMP_generations_{args.evaluation_model}_likelihoods.pkl')
with open(f'{path_prefix}{args.generation_model}_ANALYSIS_TEMP_generations_{args.evaluation_model}_likelihoods.pkl', 'wb') as outfile:
